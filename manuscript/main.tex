...
the coordinate decoder under-resolving the sharp PSF core and reduce it with a sharper
frequency encoding. Color conditioning further removes a chromatic PSF-size systematic
...
spectral bias of the coordinate decoder: a multilayer-perceptron decoder preferentially fits smooth
functions and under-resolves sharp peaks. Widening the decoder's Fourier frequency basis
nearly eliminates the core deficit (${\sim}2\%\to0.1\%$ encircled-energy residual at
$r{=}2$\,px) and cuts the galaxy-size bias by ${\sim}30\%$ (to ${\sim}5\%$), at a small cost
to reserved-star ellipticity scatter; a tuned frequency schedule or a sinusoidal-activation
decoder is a plausible route to the core correction without that cost. It is the main residual systematic to address before a shear analysis. A separate, milder effect appears only in the
