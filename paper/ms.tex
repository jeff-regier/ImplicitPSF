...
quantity---at the cost of a ${\sim}8\%$ size deficit we trace to the decoder's sharp-core
representation and address directly. Color
...
PSF core, and address it in \S\ref{sec:discussion}. The size deficit is the main residual
systematic we target; recovered ellipticity, the consequential quantity for shear, is
unbiased for our model.
\begin{figure}
\centering
