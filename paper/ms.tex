...
functions and under-resolve sharp peaks---and expect sharper positional encodings (Fourier
features) or a core-weighted loss to mitigate it; it is the main residual systematic to
address before a shear analysis. A separate, milder effect appears only in the
