...
than fitting a sub-pixel profile and assuming a pixel kernel. This is also what makes the
benchmark fair: we score all three methods on moments measured in pixel space (model
stamp versus star stamp), so no method is privileged by its internal representation. The
